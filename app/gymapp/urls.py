...
from .views.weightviews import LossView, GainView, userLoss, userWeight, getLoss, getTotalLoss, userGain, getGain, getTotalGain, aUserLoss, getATotalGain, getATotalLoss, userTodayWeight
...
urlpatterns = [
    ...
    path('users/loss/<int:id>', userLoss),   
