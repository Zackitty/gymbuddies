...
from .views.exerciseviews import ExerciseView, ExerciserView, getExercise, getExercisers, getAnExerciser, getExerciserExercises
urlpatterns = [
    ...
    path('users/<int:id>/exerciserexercises', getExerciserExercises),
